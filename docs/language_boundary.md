...
- Keywords: `prototype`, `sealed`, `function`, `var`, `const`, `internal`, `group`, `int`, `float`, `bool`, `byte`, `glyph`, `string`, `list`, `map`, `slice`, `view`, `void`, `if`, `else`, `for`, `of`, `in`, `while`, `do`, `switch`, `case`, `default`, `break`, `continue`, `return`, `try`, `catch`, `finally`, `throw`, `true`, `false`, `self`, `super`, `import`, `as`
- Core types: `bool`, `byte`, `int`, `float`, `glyph`, `string`, `void`, `list`, `map`, `slice`, `view`, `Self` (type contextuel normatif pour `clone`)
