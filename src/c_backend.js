...
function emitRuntimeHelpers(protoMap) {
  ...
  return [
    ...
    "  if (!dir || dir[0] == '\\0') ps_panic(\"R1010\", \"RUNTIME_IO_ERROR\", \"TEMP not set\");",
    "  return dir;",
    "#else",
    ...
    "    uint8_t rnd[16];",
    "    if (!ps_rand_bytes(rnd, sizeof(rnd))) ps_panic(\"R1010\", \"RUNTIME_IO_ERROR\", \"tempPath failed\");",
    "    char hex[33];",
    ...
    "    free(full);",
    "  }",
    "  ps_panic(\"R1010\", \"RUNTIME_IO_ERROR\", \"tempPath failed\");",
    "  return ps_cstr(\"\");",
    "}",
